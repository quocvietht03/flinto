	...
	<div class="product">
		<div class="quick-view-image images">
			...
			<?php else : ?>
				...
				<img src="<?php echo esc_url( wc_placeholder_img_src() ) ; ?>" alt="<?php esc_attr_e( 'Placeholder', 'flintotheme' ); ?>" />

			<?php endif; ?>

			<a class="quick-view-detail-button button" href="<?php echo esc_url( get_permalink( $product->get_id() ) ) ; ?>"><?php _e( 'View Full Details', 'flintotheme' ); ?></a>
