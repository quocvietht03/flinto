            ...
            switch( layout ) {
                case 'default':
                    ...
                    if( $self.hasClass( '__is-active' ) ) {
                        $('.flintotheme-archive-filter-tool-bar').stop(true, false).slideDown('slow', function() {
                            $(w).trigger('resize');
                        ...
                        $('.flintotheme-archive-filter-tool-bar').stop(true, false).slideUp('slow', function() {
                            $(w).trigger('resize')
                        });
                    }
                    break;
                ...
                case 'off-canvas':
                    $('.flintotheme-archive-filter-tool-bar').toggleClass( '__is-showing' );
                    break;
            }
        } )
