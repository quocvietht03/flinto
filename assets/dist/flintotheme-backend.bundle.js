            ...
            methods: {
                ...
                GetButtonType() {
                    ...
                    $.ajax({
                        ...
                        data: { action: 'flintotheme_ajax_get_plugin_install_type', plugin: self.PluginData },
                        success(res) {
                ...
                InstallActivePlugin(data, evt) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: theme_backend_script_object.ajax_url,
                        data: {action: 'flintotheme_ajax_install_plugin_handle', data: data},
                        success(res) {
                            // enable ui plugin
                ...
                ActivePlugin(data, evt) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: theme_backend_script_object.ajax_url,
                        data: {action: 'flintotheme_ajax_active_plugin_handle', data: data},
                        success(res) {
                            // enable ui plugin
                            _store.Set_DisablePluginCompatibleUi(false);
        ...
        methods: {
            SaveThemeAdvancedOptions( data ) {
                ...
                $.ajax({
                    type: 'POST',
                    url: theme_backend_script_object.ajax_url,
                    data: { action: 'flintotheme_update_theme_advanced_options_ajax', theme_advanced_options: data },
                    success ( res ) {
            ...
            LoadThemeAdvancedOptions() {
                ...
                $.ajax({
                    type: 'POST',
                    url: theme_backend_script_object.ajax_url,
                    data: { action: 'flintotheme_load_theme_advanced_options_ajax' },
                    success ( res ) {
            ...
            DoInstallPackage(package_data, _is_step, _extra_params) {
                ...
                var send_data = {
                    action: 'flintotheme_ajax_install_demo_content',
        ...
        $el.on( {
            ...
            '__theme_validate.request_deactivate_license' (e) {
                ...
                $.ajax({
                    ...
                    url: theme_backend_script_object.ajax_url,
                    data: {
                        action: 'flintotheme_ajax_deactive_license_theme',
                    },
                    success ( res ) {
            ...
            '__theme_validate.request_check_purchase_code' ( e, code ) {
                ...
                $.ajax({
                    ...
                    url: theme_backend_script_object.ajax_url,
                    data: {
                        action: 'flintotheme_ajax_purchase_code_validate',
                        purchase_code: code,
                    },
                    success ( res ) {
                        $self.trigger( '__theme_validate.is_load_ajax', [false] );
...
/******/ });
//# sourceMappingURL=flintotheme-backend.bundle.js.map