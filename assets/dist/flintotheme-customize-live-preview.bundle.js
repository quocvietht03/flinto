...
! (function(wp, $){
   ...
   * header
   */
	wp.customize('flintotheme_header_builder_data', function(value) {
   ...
   * designer
   */
  wp.customize('flintotheme_designer_settings', function(value) {
    var designer_helpers_object = new _modules_designer_helpers__WEBPACK_IMPORTED_MODULE_0__["default"]({
      styleElemId: 'flintotheme-designer-inline-css',
    });
  ...
  wp.customize('flintotheme_designer_google_fonts', function(value) {
    value.bind(function(newval) {
      if(! newval) return;
      var obj_value = JSON.parse(newval);
...
/******/ });
//# sourceMappingURL=flintotheme-customize-live-preview.bundle.js.map