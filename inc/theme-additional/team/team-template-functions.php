...
if( ! function_exists('flintotheme_team_get_custom_archive_page_template') ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_get_custom_archive_page_template( $archive_template ) {
        global $post;
...
if( ! function_exists('flintotheme_team_before_archive_content_open') ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_before_archive_content_open() {
        ?>
        <div id="main-content" class="team-main-content"> <!-- open #main-content -->
            <div class="<?php do_action('flintotheme_container_class') ?>"> <!-- open flintotheme_container_class -->
        <?php
    }
}

if( ! function_exists('flintotheme_team_before_archive_content_close') ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_before_archive_content_close() {
        ?>
            </div> <!-- close flintotheme_container_class -->
        </div> <!-- close #main-content -->
        <?php
    }
}

if(! function_exists('flintotheme_team_before_archive_content_masonry_open')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_before_archive_content_masonry_open() {
        $furygrid_opts = array(
            'Col' => 4,
            'Space' => 35,
            'Responsive' => array(
...
if(! function_exists('flintotheme_team_archive_item_entry_func')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_archive_item_entry_func() {
        global $post;
        include __DIR__ . '/templates/archive-team-loop-template.php';
    }
}

if(! function_exists('flintotheme_team_before_archive_content_masonry_close')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_before_archive_content_masonry_close() {
        ?>
        </div>
        <?php
    }
...
if( ! function_exists( 'flintotheme_team_get_custom_post_type_template' ) ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_get_custom_post_type_template( $single_template ) {
        global $post;

        if ( 'team' == $post->post_type ) {

            // remove heading bar
            remove_action( 'flintotheme_content_top', 'flintotheme_heading_bar_func', 10 );
            add_action( 'flintotheme_content_top', 'flintotheme_team_add_team_cover_func', 20 );
...
if( ! function_exists( 'flintotheme_team_add_team_cover_func' ) ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_add_team_cover_func() {
        include dirname( __FILE__ ) . '/templates/single-team-cover-template.php';
    }
}

if( ! function_exists( 'flintotheme_team_single_image_cover_func' ) ) {
    /**
     * @since 1.0.0
     *  
     */
    function flintotheme_team_single_image_cover_func() {
        global $post;
...
if(! function_exists('flintotheme_team_single_entry_open')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_single_entry_open() {
        ?>
...
if(! function_exists('flintotheme_team_single_entry_close')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_single_entry_close() {
        ?>
...
if(! function_exists('flintotheme_team_single_avatar_box_html')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_single_avatar_box_html() {
        global $post;
        ...
        <div class="post-team-avatar-box">
            <div class="__inner">
                ...
                <?php do_action( 'flintotheme_team_avatar_after_avatar' ); ?>
                <div class="team-avatar-entry">
                    <h2 class="team-name"><?php the_title(); ?></h2>
                </div>
                <?php do_action( 'flintotheme_team_avatar_after_entry' ); ?>
            </div>
        </div>
        <?php
    }
...
if(! function_exists('flintotheme_team_qoute_box_html')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_qoute_box_html() {
        global $post;
...
if(! function_exists('flintotheme_team_follow_me_html')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_follow_me_html() {
        global $post;
        $social_button_link_temp = apply_filters( 'flintotheme_team_social_bottom_link_temp' , array(
            'facebook' => '<a href="{{link_social}}" class="__button-link-social s-facebook {{extra_class}}" target="_blank"><span class="__icon"><i class="fa fa-facebook"></i></span><span class="__text">'. __( 'Facebook', 'flintotheme' ) .'</span></a>',
            'twitter' => '<a href="{{link_social}}" class="__button-link-social s-twitter {{extra_class}}" target="_blank"><span class="__icon"><i class="fa fa-twitter"></i></span><span class="__text">'. __( 'Twitter', 'flintotheme' ) .'</span></a>',
            'google_plus' => '<a href="{{link_social}}" class="__button-link-social s-google-plus {{extra_class}}" target="_blank"><span class="__icon"><i class="fa fa-google-plus"></i></span><span class="__text">'. __( 'Google plus', 'flintotheme' ) .'</span></a>',
        ));
        ?>
        <div class="post-team-follow-me-via-social">
            <div class="__heading">
                <?php _e( 'Follow me on social', 'flintotheme' ); ?>
            </div>
...
if(! function_exists('flintotheme_team_single_content_html')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_single_content_html() {
        $classes = apply_filters( 'flintotheme_team_single_content_classes_filter', array( 'post-team-content' ) );
        ?>
        <div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
            <?php do_action( 'flintotheme_team_before_content_inner' ); ?>
            <div class="__inner __team-description">
                <?php do_action( 'flintotheme_team_before_content' ); ?>
                <?php the_content(); ?>
                <?php do_action( 'flintotheme_team_after_content' ); ?>
            </div>
            <?php do_action( 'flintotheme_team_after_content_inner' ); ?>
        </div>
        <?php
    }
}

if(! function_exists('flintotheme_team_features_section_container')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_features_section_container() {
        global $post;
        ...
        <div class="post-team-features-section-container">
            <?php foreach( $features_section_data as $index => $feature_item ) { ?>
                <div class="team-feature-section-item type-<?php echo esc_attr( $feature_item['team_features_section_type'] ); ?>">
                    <?php do_action( 'flintotheme_team_feature_section_type_' . $feature_item['team_features_section_type'], $feature_item ); ?>
                </div>
            <?php } ?>
        </div>
        <?php
...
if(! function_exists('flintotheme_team_feature_section_type_skill_progress_bar_func')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_feature_section_type_skill_progress_bar_func( $data ) {
        $skill_progress_bar_data = $data['skill_progress_bar_data'];
        if( count( $skill_progress_bar_data ) <= 0 ) return;
        ?>
        <h4 class="feature-title"><?php echo apply_filters( 'flintotheme_team_feature_section_item_title', $data['section_title'], $data['section_title'] ); ?></h4>
...
if(! function_exists('flintotheme_team_feature_section_type_timeline_func')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_feature_section_type_timeline_func( $data ) {
...
if(! function_exists('flintotheme_team_jetpack_project_team_html')) {
    /**
     * @since 1.0.0
     *  
     */
    function flintotheme_team_jetpack_project_team_html() {
        global $post;
...
if(! function_exists('flintotheme_team_infomation_inline_html')) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_infomation_inline_html() {
        global $post;
                ...
                <div class="col-md-3 col-sm-6 col-6">
                    <div class="team-infomation-item __main-work">
                        <label>
                            ...
                            <span class="label-name"><?php echo empty( $team_main_work ) ? __( 'n/a', 'flintotheme' ) : $team_main_work; ?></span>
                        </label>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6">
                    <div class="team-infomation-item __location">
                        <label>
                            ...
                            <span class="label-name"><?php echo empty( $team_location ) ? __( 'n/a', 'flintotheme' ) : $team_location; ?></span>
                        </label>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6">
                    <div class="team-infomation-item __phone-number">
                        <label>
                            ...
                            <span class="label-name"><?php echo empty( $team_phone_number ) ? __( 'n/a', 'flintotheme' ) : $team_phone_number; ?></span>
                        </label>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6">
                    <div class="team-infomation-item __email">
                        <label>
                            ...
                            <span class="label-name"><a href="mailto:<?php echo esc_attr( $team_email ); ?>"><?php echo empty( $team_email ) ? __( 'n/a', 'flintotheme' ) : $team_email; ?></a></span>
                        </label>
                    </div>
                </div>
            </div>
...
if( ! function_exists('flintotheme_team_portfolio_button_switch_html') ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_portfolio_button_switch_html() {
        $buttons = apply_filters( 'flintotheme_team_portfolio_button_switch_filter', array(
            'description' => '<a href="#" class="__btn-switch __is-active" data-active-container=".__team-description">'. __( 'About Me', 'flintotheme' ) .'</a>',
            'portfolio' => '<a href="#" class="__btn-switch" data-active-container=".__team-projects">'. __( 'Projects', 'flintotheme' ) .'</a>',
        ) );
        ?>
...
if( ! function_exists( 'flintotheme_team_portfolio_post_list_html' ) ) {
    /**
     * @since 1.0.2
     *  
     */
    function flintotheme_team_portfolio_post_list_html() {
        global $post;
        $team_id = $post->ID;
