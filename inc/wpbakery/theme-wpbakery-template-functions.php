...
if(! function_exists('flintotheme_bevc_element_block_slide_items__add_layout_image_large')) {
    /**
     * @since 1.0.0
     *  
     */
    function flintotheme_bevc_element_block_slide_items__add_layout_image_large($post, $atts) {
