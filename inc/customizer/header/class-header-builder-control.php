 ...
 *
 */
class Flintotheme_Header_Builder_Control extends WP_Customize_Control {

	public function render_content() {
		?>
		<div id="theme-extends-header-action-control">
			<div class="theme-extends-customize-control-title"><?php _e( 'Header Customizer', 'flintotheme' ) ?></div>
			<div class="theme-extends-message">
				<span class="ion-information-circled"></span>
				<?php _e('The Header Customizer allows you to creative header layout with drag-drop the components.', 'flintotheme'); ?>
			</div>
