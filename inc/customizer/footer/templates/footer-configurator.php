...
<div id="theme-extends-footer-configurator" class="theme-extends-panel">
  ...
  <div :class="footer_panel_inner_classes">
    ...
    <div class="theme-extends-message" style="background: #eee; box-shadow: none;">
      ...
      <?php _e('Allow creating layout footer easy, start with new row & columns, use components on the left sidebar by drag and drop.', 'flintotheme'); ?>
    </div>

    <div class="footer-field-name-wrap">
      <input class="footer-field-name-input" type="text" v-model="footer_edit.name" placeholder="<?php esc_attr_e('Input footer layout name', 'flintotheme') ?>"/>
    </div>
