 ...
 *
 */
class Flintotheme_Designer_Control extends WP_Customize_Control {
	...
	public function render_content() {
      ...
      <div style="text-align: right">
        <el-popover
          ...
          ref="stylelist"
          placement="bottom"
          title="<?php esc_attr_e('Select design element', 'flintotheme'); ?>"
          width="200"
          trigger="click"
        ...
        <div class="theme-extends-add-style-area" v-popover:stylelist><i class="el-icon-plus"></i> <?php _e('Add a Style', 'flintotheme') ?></div>
				...
				<transition name="theme-extends-fade">
					<div v-if="element_target" class="theme-extends-message">
						...
						<?php _e('Select an editable element on your page to the right to adjust its properties.', 'flintotheme'); ?>
					</div>
				</transition>

				<transition name="theme-extends-fade">
					<div v-if="element_target_list.length > 0" class="theme-extends-margin theme-extends-selector-element-list-wrap">
						<p><?php _e('Select item for design!', 'flintotheme') ?></p>
      ...
      <div id="theme-extends-design-panel" :class="design_panel_class">
        <div v-if="Object.keys(designer_store.data_edit).length > 0" class="design-panel-inner">
          <div class="heading">
            <div class="back-handle" @click="clear_edit()"><i class="ion-ios-arrow-left" title="<?php esc_attr_e('Back', 'flintotheme'); ?>"></i></div>
          ...
          <div class="design-group">
						...
						<div class="add-group-style">
							...
							<div class="add-group-style-inner" v-popover:popover-group-style><span class="ion-plus-round"></span> <?php _e('Add Style', 'flintotheme'); ?></div>
						</div>
						<br />
