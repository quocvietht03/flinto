 ...
 */
class Flintotheme_Widget_Language_Switching extends Flintotheme_Widget_Abstract {

	// Register widget function. Must have the same name as the class
    function __construct() {
        $this->setup(
            'theme_widget_language_switching',
            __('Theme Widget - Language Switching', 'flintotheme'),
            __('Displays language switching', 'flintotheme'),
            array(
                Field::make( 'text', 'title', __('Title', 'flintotheme') )
                    ->set_default_value( __('Language Switching', 'flintotheme') ),
                Field::make( 'complex', 'language_switching_data' )
                    ->add_fields( array(
                        Field::make( 'text', 'lan_label', __( 'Label', 'flintotheme' ) )
                            ->set_required( true ),
                        Field::make( 'text', 'lan_direct_url', __( 'Direct Url', 'flintotheme' ) )
                            ->set_required( true ),
                    ) )
                    ->set_default_value( array(
                        array(
                            'lan_label' => __('English', 'flintotheme'),
                            'lan_direct_url' => '#'
                        ),
                        array(
                            'lan_label' => __('România', 'flintotheme'),
                            'lan_direct_url' => '#'
                        ),
                    ) )
                    ->set_collapsed( true )
    ...
    public function _render_layout_default($instance) {
		...
		<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
            ...
            <div 
                ...
                <span class="__label"><?php _e( 'Language', 'flintotheme' ); ?></span>
