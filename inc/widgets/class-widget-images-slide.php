 ...
 */
class Flintotheme_Widget_Images_Slide extends Flintotheme_Widget_Abstract {

	// Register widget function. Must have the same name as the class
    function __construct() {
        $this->setup(
            'theme_widget_images_slide',
            __('Theme Widget - Images Slide', 'flintotheme'),
            __('Displays a images slide (banners)', 'flintotheme'),
            array(
                Field::make( 'text', 'title', __('Title', 'flintotheme') )->set_default_value( __('Banner', 'flintotheme') ) ,
