 ...
 */
class Flintotheme_Widget_Delipress_Custom_Mini_Form extends Flintotheme_Widget_Abstract {

	// Register widget function. Must have the same name as the class
    function __construct() {
        $this->setup(
            'theme_widget_delipress_custom_mini_form',
            __('Theme Widget - Delipress Custom Mini Form', 'flintotheme'),
            __('Displays Delipress Mini Form - Short descriptions & E-mail field', 'flintotheme'),
            array(
    ...
    function front_end( $args, $instance ) {
        ...
        if(! empty($instance['class_custom_design'])) {
            ...
            $custom_design_selector = wp_json_encode( array(
                ...
                array(
                    'name' => __('Delipress custom form - Button submit', 'flintotheme'),
                    'selector' => $_root_classes . ' .__inner .delipress-entry .btn-submit',
                ),
                array(
                    'name' => __('Delipress custom form - Button submit (:hover)', 'flintotheme'),
        ...
        <div 
            ...
            <?php echo apply_filters( 'flintotheme_widget_delipress_custom_mini_form_design_name_attr', $custom_design_name_attr ); ?> 
            <?php echo apply_filters( 'flintotheme_widget_delipress_custom_mini_form_design_selector_attr', $custom_design_selector_attr ); ?>>
            <div class="__inner">
