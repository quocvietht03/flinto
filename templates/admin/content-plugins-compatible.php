<?php 
global $flintotheme;
$flintotheme_plugins_compatible = $flintotheme->conf_required['plugins_compatible'];

// flintotheme_button_action_install_plugin(array(
...
<div class="__plugin-compatible-listing" v-loading="ShareStore.DisablePluginCompatibleUi">
    <?php  
    if( empty($flintotheme_plugins_compatible) || count($flintotheme_plugins_compatible) <= 0 ) return;
    echo implode( '', array(
        '<el-row :gutter="30">',
    ) );
    foreach($flintotheme_plugins_compatible as $item) {
