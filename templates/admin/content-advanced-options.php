                ...
                <el-col :lg="8" :sm="12">
                    <div class="__block-options">
                        <div class="heading-option">
                            <?php _e( 'Custom content types (Since v1.0.2)', 'flintotheme' ); ?> 
                        </div>
                        <div class="container-options">
                            <div class="__opts-group">
                                <p><?php _e( 'Add team to your website. Load custom post type "Team" and more options if combined with jetpack portfolio.', 'flintotheme' ) ?></p>
                                <div class="__field-item">
                                    ...
                                    <label style="margin-left: 10px;"><?php _e( 'On / Off Post Teams', 'flintotheme' ); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
