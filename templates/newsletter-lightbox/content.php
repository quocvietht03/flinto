...
<div 
    ...
    <div class="dnl-newsletter-lightbox-container __layout-default">
        ...
        <div class="dnl-entry">
            ...
            <?php do_action( 'flintotheme_delipress_newsletter_lightbox_form', 'default' ); ?>
        </div>
...
<a href="<?php echo esc_url( '#' ); ?>" id="delipress-newsletter-lightbox-element__open" class="delipress-newsletter-lightbox__open">
    <img src="<?php echo get_template_directory_uri() . '/assets/images/svg-icons/sent-mail.svg' ?>" alt="<?php esc_attr_e('Open newsletter', 'flintotheme') ?>" />
</a>